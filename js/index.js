function isDefined(objectToValidate, defaultValue) {
  return "undefined" == typeof objectToValidate
...
function FormBuilder(pars) {
  ...
  return (
    ...
    isDefined(this.params.form_selector)
      ? ((this.form = $(this.params.form_selector)),
        0 == this.form.length
          ? !1
          : isDefined(this.params.submit_selector)
            ? ((this.submitButton = $(this.params.submit_selector, this.form)),
              0 == this.submitButton.length
                ? !1
                : (this.submitButton.data("form", this.form),
                  "submit" != this.submitButton.attr("type") &&
                    this.submitButton.bind("click", function (e) {
                      (e.preventDefault(),
                        _this.form.valid() && _this.form.submit());
                    }),
                  isDefined(this.params.validation) &&
                    (this.createValidation(this.params.validation),
                    isDefined(this.params.validation.conditional_required) &&
                      this.createConditionalRequired(
                        this.params.validation.conditional_required,
                      )),
                  ...
                  jQuery.validator.addMethod("postalcode_pt", function (value) {
                    ...
                    return (
                      (pattern.test(value) && 8 == value.length) || "" == value
                    );
                  }),
                  ...
                  void jQuery.validator.addMethod(
                    "added_pets",
                    function (value) {
                      if ("" != value) {
...
function Portfolio($scope, $element) {
  ...
  ((this.projects = {}),
    ...
    (this.winW = null),
    this.win.bind("scroll.Portfolio", function () {
      _this.scrollHandler();
    }),
  ...
  for (var i = 0; i < _portfolioList.length; i++) {
    ...
    for (
      var newSliderImages = [], n = 0;
      n < this.projects[o._id].images.length;
      n++
    ) {
  ...
  (this.resizeHandler(!1),
    this.win.bind("load.Portfolio", function () {
...
function Navigation() {
  ...
  ((this.body = $("body")),
    (this.menu = $("header")),
    (this.buttons = $(
      ".second-nav a, header a, body > footer .bt-up, section.banner .bt-down",
    )),
    ...
    (this.win = $(window)),
    this.win.bind("scroll.Navigation", function () {
      that.scrollHandler();
    }),
...
(!(function (e, undefined) {
  ...
  ((x.fn = x.prototype =
    ...
    x.extend({
      ...
      merge: function (e, t) {
        ...
        else for (; t[i] !== undefined; ) e[r++] = t[i++];
        return ((e.length = r), e);
      },
      grep: function (e, t, n) {
        var r,
        ...
        return (
          ...
          at(function (o, s, a, u) {
            var l,
              ...
              y = n ? (i || (o ? e : d || r) ? [] : s) : m;
            if ((n && n(m, y, a, u), r))
              for (l = xt(y, h), r(l, [], a, u), c = l.length; c--; )
                (p = l[c]) && (y[h[c]] = !(m[h[c]] = p));
            if (o) {
              if (i || e) {
                if (i) {
  ...
  ((ct.optgroup = ct.option),
    ...
    x.each(
      ...
      function (e, t) {
        x.fn[e] = function (e) {
          for (var n, r = [], i = x(e), o = i.length - 1, s = 0; o >= s; s++)
  ...
  (function (W, X, u) {
    ...
    function Bb(b, a) {
      ...
      return !N(a) || a instanceof RegExp
        ? a
        : c.length
          ? function () {
              return arguments.length
                ? a.apply(b, c.concat(wa.call(arguments, 0)))
                : a.apply(b, c);
            }
          : function () {
    ...
    function dc(b, a) {
      ...
      return W && !d.test(W.name)
        ? c()
        : ((W.name = W.name.replace(d, "")),
          void (Xa.resumeBootstrap = function (b) {
            (r(b, function (b) {
              a.push(b);
            }),
              c());
    ...
    function fc(b, a, c) {
      if (!a) return b;
      a = a.split(".");
      for (var d, e = b, f = a.length, g = 0; f > g; g++)
        ((d = a[g]), b && (b = (e = b)[d]));
        ...
        if ((c = je.exec(a))) b = [b.createElement(c[1])];
          ...
          if (((b = d.createDocumentFragment()), (c = []), Ib.test(a))) {
            for (
              ...
              d = d.lastChild;
            for (a = 0, e = d.childNodes.length; e > a; ++a)
    ...
    function pa(b, a, c) {
      var d = b.ng339,
        d = cb[d || -1];
      return D(c)
        ? (d || ((b.ng339 = d = ++me), (d = cb[d] = {})), void (d[a] = c))
        : d && d[a];
    }
    ...
    function qb(b, a, c) {
      for (
        9 == b.nodeType && (b = b.documentElement), a = L(a) ? a : [a];
        b;
      ) {
      ...
      return (
        "function" == typeof b
          ? (a = b.$inject) ||
            ((a = []),
            b.length &&
              ((c = b.toString().replace(oe, "")),
              (c = c.match(pe)),
              r(c[1].split(qe), function (b) {
            ...
            (b.$inject = a))
          : L(b)
            ? ((c = b.length - 1), Ya(b[c], "fn"), (a = b.slice(0, c)))
            : Ya(b, "fn", !0),
        a
      );
    }
    ...
    function ec(b) {
      ...
      function c(a, b) {
        if (
          (Ea(a, "service"), (N(b) || L(b)) && (b = n.instantiate(b)), !b.$get)
        )
          throw eb("pget", a);
        return (l[a + h] = b);
      }
    ...
    function se(b, a, c, d) {
          ...
          return (
            ...
            !e && d.history
              ? c
                ...
                : (l.pushState(null, "", a), K.attr("href", K.attr("href")))
              : (e || (B = a), c ? m.replace(a) : (m.href = a)),
            h
          );
        }
      };
      ...
      ((h.onUrlChange = function (a) {
        return (
          O ||
            (d.history && A(b).on("popstate", g),
            d.hashchange ? A(b).on("hashchange", g) : h.addPollFn(g),
            (O = !0)),
          ba.push(a),
          a
        );
            ...
            for (
              ...
              ((e = d[f]),
                ...
                h > 0 &&
                  ...
                  M[a] === u && (M[a] = unescape(e.substring(h + 1)))));
          return M;
        }
        b === u
          ? (k.cookie =
          ...
          : G(b) &&
            ((d =
              (k.cookie = escape(a) + "=" + escape(b) + ";path=" + P).length +
              1),
            d > 4096 &&
              c.warn(
                "Cookie '" +
        ...
        function b(b, d) {
          ...
          return (a[b] = {
            put: function (a, b) {
              ...
              return F(b)
                ? void 0
                : (a in k || g++, (k[a] = b), g > m && this.remove(q.key), b);
            },
            get: function (a) {
              if (m < Number.MAX_VALUE) {
                var b = l[a];
          ...
          function (a, b, l, n, q, p, s, J, w, t, y, K) {
            ...
            function O(a, b, c, d, e, f) {
              function g(a, c, d, e) {
                ...
                for (n = m = 0, q = k.length; q > m; n++)
                  ((p = s[n]),
                    (c = k[m++]),
                    (f = k[m++]),
                    c
                      ? (c.scope
                          ? ((l = a.$new()), A.data(p, "$scope", l))
                          : (l = a),
                        (w = c.transcludeOnThisElement
                          ...
                          : !c.templateOnThisElement && e
                            ...
                            : !e && b
                              ...
                              : null),
                        c(f, l, p, d, w))
                      : f && f(a, p.childNodes, u, e));
              }
              for (var p, l, m, q, k = [], n = 0; n < a.length; n++)
                ((p = new Ob()),
                  (l = ca(a[n], [], p, 0 === n ? d : u, e)),
                  (f = l.length
                    ? I(l, a[n], p, b, c, null, [], [], f)
                    : null) &&
                    f.scope &&
                    ba(p.$$element, "ng-scope"),
                  (p =
                    (f && f.terminal) || !(m = a[n].childNodes) || !m.length
                      ? null
                      : O(
                          m,
                          f
            ...
            function ca(a, b, c, d, g) {
              ...
              switch (a.nodeType) {
                case 1:
                  ...
                  for (
                    var l, m, q, n = a.attributes, w = 0, s = n && n.length;
                    s > w;
                    w++
                  ) {
                    var t = !1,
            ...
            function I(a, c, d, e, f, g, k, q, n) {
              ...
              function J(a, e, f, g, n) {
                ...
                if (
                  ...
                  var ue = /^\s*([@=&])(\??)\s*(\w*)\s*$/;
                  ((P = e.$new(!0)),
                    !I || (I !== K && I !== K.$$originalDirective)
                      ? Q.data("$isolateScopeNoTemplate", P)
                      : Q.data("$isolateScope", P),
                ...
                for (
                  ...
                  try {
                    (M = k[g])(
                      ...
                      Q,
                      y,
                      M.require && t(M.directiveName, M.require, Q, ca),
                      ra,
                    );
                  } catch (H) {
                    l(H, ia(Q));
              ...
              for (
                ...
                if (
                  ((V = H.scope) &&
                    ((M = M || H),
                    H.templateUrl ||
                      (fb("new/isolated scope", K, H, x), T(V) && (K = H))),
                  (z = H.name),
                  !H.templateUrl &&
                    H.controller &&
                    ((V = H.controller),
                    (O = O || {}),
                    fb("'" + z + "' controller", O[z], H, x),
                    (O[z] = H)),
                  (V = H.transclude) &&
                    ((F = !0),
                  ...
                  if (
                    ...
                    fb("template", I, H, x),
                    (I = H),
                    (V = N(H.template) ? H.template(x, d) : H.template),
                    (V = W(V)),
                    H.replace)
                  ) {
                    if (
                ...
                H.terminal &&
                  ((J.terminal = !0), (y = Math.max(y, H.priority)));
              }
              return (
                (J.scope = M && !0 === M.scope),
                ...
                n
                  ...
                  .success(function (q) {
                    ...
                    for (
                      ...
                      if (t !== w) {
                        var P = t.className;
                        ((k.hasElementTranscludeDirective && s.replace) ||
                          (B = Kb(n)),
                          ra(K, A(t), B),
                          ba(A(B), P));
                      }
                    ...
                    return {
                      pre: function (c, d, k) {
                        ...
                        (f = b(k[e], !0, z(a, e))) &&
                          ...
                          ((d[e] || (d[e] = [])).$$inter = !0),
                          (
                            (k.$$observers && k.$$observers[e].$$scope) ||
                            c
            ...
            function ra(a, b, c) {
              ...
              if (a)
                for (g = 0, k = a.length; k > g; g++)
                  if (a[g] == d) {
                    ((a[g++] = c), (k = g + e - 1));
                    for (var p = a.length; p > g; g++, k++)
                      p > k ? (a[g] = a[k]) : delete a[g];
                    a.length -= e - 1;
                    break;
                  }
              for (
            ...
            Ob.prototype = {
              ...
              $updateClass: function (a, b) {
                var c = sc(a, b),
                  d = sc(b, a);
                0 === c.length
                  ? y.removeClass(this.$$element, d)
                  : 0 === d.length
                    ? y.addClass(this.$$element, c)
                    : y.setClass(this.$$element, c, d);
              },
              $set: function (a, b, c, d) {
                ...
                (e && (this.$$element.prop(a, b), (d = e)),
                  ...
                  d
                    ? (this.$attr[a] = d)
                    : (d = this.$attr[a]) || (this.$attr[a] = d = nb(a, "-")),
                  (e = Pa(this.$$element)),
                  (("A" === e && "href" === a) ||
                    ("IMG" === e && "src" === a)) &&
                    (this[a] = b = K(b, "src" === a)),
      ...
      var b = /^\s*(\[|\{[^\{])/,
        ...
        e = (this.defaults = {
          ...
          transformRequest: [
            function (a) {
              return T(a) &&
                "[object File]" !== Ba.call(a) &&
                "[object Blob]" !== Ba.call(a)
                ? oa(a)
                : a;
            },
          ],
      ...
      this.$get = [
        ...
        function (a, b, c, d, n, q) {
          ...
          function s(c, f, g) {
            ...
            function q(a, b, d, e) {
              ((b = Math.max(b, 0)),
                (b >= 200 && 300 > b ? t.resolve : t.reject)({
                  data: a,
                  status: b,
                  headers: uc(d),
                  config: c,
            ...
            return (
              F(I) &&
                ((I = Pb(c.url)
                  ...
                  : u) && (g[c.xsrfHeaderName || e.xsrfHeaderName] = I),
                a(
                  c.method,
                  A,
                  f,
    ...
    function xe(b) {
      if (
        8 >= R &&
        (!b.match(/^(get|post|head|put|delete|options)$/i) || !W.XMLHttpRequest)
      )
    ...
    function ye(b, a, c, d, e) {
      ...
      return function (e, k, m, l, n, q, p, s) {
        ...
        if (
          ...
          var K = f(
            k.replace("JSON_CALLBACK", "angular.callbacks." + y),
            y,
            function (a, b) {
            ...
            (B.onreadystatechange = function () {
              if (B && 4 == B.readyState) {
                var a = null,
                  ...
                  c = "";
                (t !== g &&
                  ((a = B.getAllResponseHeaders()),
                  (b = "response" in B ? B.response : B.responseText)),
      ...
      ((this.startSymbol = function (a) {
        ...
        (this.$get = [
          ...
          function (c, d, e) {
            function f(f, m, l) {
              for (
                var n, q, p = 0, s = [], J = f.length, w = !1, t = [];
                J > p;
              )
                -1 != (n = f.indexOf(b, p)) && -1 != (q = f.indexOf(a, n + g))
                  ? (p != n && s.push(f.substring(p, n)),
                    s.push((p = c((w = f.substring(n + g, q))))),
                    (p.exp = w),
                    (p = q + h),
                    (w = !0))
                  : (p != J && s.push(f.substring(p)), (p = J));
              if (((J = s.length) || (s.push(""), (J = 1)), l && 1 < s.length))
                throw wc("noconcat", f);
              return !m || w
                ? ((t.length = J),
                  (p = function (a) {
                    try {
                      for (var g, b = 0, c = J; c > b; b++) {
                        if ("function" == typeof (g = s[b]))
                          if (
                            ((g = g(a)),
                            (g = l ? e.getTrusted(l, g) : e.valueOf(g)),
                            null == g)
                          )
                            g = "";
                          else
            ...
            return (
              ...
              (q.$$intervalId = m(function () {
                (n.notify(p++),
                  h > 0 &&
                    p >= h &&
                    (n.resolve(p), l(q.$$intervalId), delete e[q.$$intervalId]),
                  s || b.$apply());
              }, g)),
              (e[q.$$intervalId] = n),
              q
      ...
      ((this.hashPrefix = function (a) {
        ...
        (this.$get = [
          ...
          function (c, d, e, f) {
            ...
            (a
              ? ((k =
                  m.substring(0, m.indexOf("/", m.indexOf("//") + 2)) +
                  (k || "/")),
                (e = e.history ? zc : Ac))
              : ((k = Ga(m)), (e = Tb)),
              (h = new e(k, "#" + b)),
              ...
              if (!a.ctrlKey && !a.metaKey && 2 != a.which) {
                ...
                (T(e) &&
                  ...
                  l.test(e) ||
                    ...
                    h.absUrl() != d.url() &&
                      (c.$apply(),
                      (W.angular["ff-684208-preventDefault"] = !0))));
              }
            }),
    ...
    function Dc(b, a, c) {
      ...
      if (a.csp)
        h =
          6 > g
            ? Cc(f[0], f[1], f[2], f[3], f[4], c, a)
            : function (b, d) {
                var h,
                  e = 0;
                do
                  ((h = Cc(f[e++], f[e++], f[e++], f[e++], f[e++], c, a)(b, d)),
                    (d = u),
                    (b = h));
                while (g > e);
                return h;
              ...
              $destroy: function () {
                if (!this.$$destroyed) {
                  ...
                  (this.$broadcast("$destroy"),
                    (this.$$destroyed = !0),
                    this !== q &&
                      (r(this.$$listenerCount, Bb(null, l, this)),
                      a.$$childHead == this &&
                      ...
                      (this.$$watchers =
                        ...
                        this.$$postDigestQueue =
                          []),
                      (this.$destroy = this.$digest = this.$apply = v),
                      (this.$on = this.$watch =
                        function () {
                          return v;
                        })));
      ...
      this.$get = [
        ...
        function (b, a) {
          var h,
            c = {},
            d = U(
              (/android (\d+)/.exec(x((b.navigator || {}).userAgent)) || [])[1],
            ),
          ...
          if (m) {
            ...
            (h || (h = "WebkitOpacity" in m && "webkit"),
              ...
              !d ||
                (l && n) ||
                ((l = G(f.body.style.webkitTransition)),
    ...
    function xa(b) {
      ...
      return (
        ...
        Y.setAttribute("href", c),
        {
          ...
          port: Y.port,
          pathname:
            "/" === Y.pathname.charAt(0) ? Y.pathname : "/" + Y.pathname,
        }
      );
    }
    ...
    function Hc(b) {
      ...
      return function (b, d) {
        return (
          ...
          Lc(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, 2).replace(
            /\u00A4/g,
            d,
          )
        );
    ...
    function Ic(b) {
      ...
      return function (c, e) {
        ...
        for (; e; )
          (k = Le.exec(e))
            ? ((g = g.concat(wa.call(k, 1))), (e = g.pop()))
            : (g.push(e), (e = null));
        return (
          r(g, function (a) {
            ((h = Me[a]),
    ...
    function He() {
      return function (b, a) {
        if (!L(b) && !G(b)) return b;
        if (((a = 1 / 0 === Math.abs(Number(a)) ? Number(a) : U(a)), G(b)))
          return a ? (a >= 0 ? b.slice(0, a) : b.slice(a, b.length)) : "";
        var d,
          e,
          c = [];
        for (
      ...
      return function (a, c, d) {
        ...
        function f(a, b) {
          var c = typeof a,
            d = typeof b;
          return c == d
            ? (va(a) && va(b) && ((a = a.valueOf()), (b = b.valueOf())),
    ...
    function Ne(b, a, c, d, e) {
      T(e) &&
        ...
        b.$parsers.push(function (f) {
          return b.$error[a] || Oc(e, d) || !Oc(e, c)
            ? f
            : void b.$setValidity(a, !1);
        }));
    }
    ...
    function Ab(b, a, c, d, e, f) {
      ...
      var n = function (e) {
        if (!l) {
          var f = a.val();
          R && "input" === (e || k).type && a[0].placeholder !== h
            ? (h = a[0].placeholder)
            : ("password" !== m && Wa(c.ngTrim || "T") && (f = $(f)),
    ...
    ((R = U((/msie (\d+)/.exec(x(navigator.userAgent)) || [])[1])),
      isNaN(R) &&
        (R = U(
          (/trident\/.*; rv:(\d+)/.exec(x(navigator.userAgent)) || [])[1],
        )),
      (v.$inject = []),
      (ga.$inject = []));
    var L = (function () {
    ...
    var Oa = (S.prototype = {
        ready: function (b) {
          ...
          "complete" === X.readyState
            ? setTimeout(a)
            : (this.on("DOMContentLoaded", a), S(W).on("load", a));
        },
        toString: function () {
          var b = [];
          return (
      ...
      r(
        {
          ...
          scope: function (b) {
            return (
              A.data(b, "$scope") ||
              qb(b.parentNode || b, ["$isolateScope", "$scope"])
            );
          },
        ...
        function (b, a) {
          S.prototype[a] = function (a, d) {
            ...
            if (
              ...
              for (
                e = b.$dv, g = e === u ? Math.min(g, 1) : g, f = 0;
                g > f;
                f++
              ) {
                var h = b(this[f], a, d);
              ...
              r(d.split(" "), function (d) {
                ...
                if (!f) {
                  if ("mouseenter" == d || "mouseleave" == d) {
                    var l =
                      X.body.contains || X.body.compareDocumentPosition
                        ? function (a, c) {
    ...
    Ub.prototype = {
      ...
      readIdent: function () {
        for (
          var e, f, g, h, a = this, c = "", d = this.index;
          this.index < this.text.length &&
          ((h = this.text.charAt(this.index)),
          "." === h || this.isIdent(h) || this.isNumber(h));
        )
          ("." === h && (e = this.index), (c += h), this.index++);
        if (e)
      ...
      (gb.prototype = {
        ...
        ternary: function () {
          ...
          return this.expect("?")
            ? ((c = this.assignment()),
              (d = this.expect(":"))
                ? this.ternaryFn(a, c, this.assignment())
                : void this.throwError("expected :", d))
            : a;
        },
        logicalOR: function () {
        ...
        unary: function () {
          ...
          return this.expect("+")
            ? this.primary()
            : (a = this.expect("-"))
              ? this.binaryFn(gb.ZERO, a.fn, this.unary())
              : (a = this.expect("!"))
        ...
        compile: function (a, c) {
          return (
            8 >= R &&
              ...
              a.append(X.createComment("IE fix"))),
            c.href || c.xlinkHref || c.name
              ? void 0
              : function (a, c) {
                  var f =
                    "[object SVGAnimatedString]" === Ba.call(c.prop("href"))
                      ? "xlink:href"
                      : "href";
          ...
          return {
            ...
            link: function (d, e, f) {
              var g = a,
                h = a;
              ("href" === a &&
                "[object SVGAnimatedString]" === Ba.call(e.prop("href")) &&
                ((h = "xlinkHref"), (f.$attr[h] = "xlink:href"), (g = null)),
                f.$observe(c, function (c) {
                  c
                    ? (f.$set(h, c), R && g && e.prop(g, f[h]))
                    : "href" === a && f.$set(h, null);
                }));
            },
          };
          ...
          (e.addClass(Ra),
            ...
            (this.$setValidity = function (a, c) {
              q[a] !== !c &&
                (c
                  ? (q[a] && n--,
                    n || (h(!0), (this.$valid = !0), (this.$invalid = !1)))
                  : (h(!1), (this.$invalid = !0), (this.$valid = !1), n++),
                (q[a] = !c),
                h(c, a),
            ...
            if (e) {
              ...
              var f = function (a) {
                return d.required && e.$isEmpty(a)
                  ? void e.$setValidity("required", !1)
                  : (e.$setValidity("required", !0), a);
              };
              (e.$formatters.push(f),
                e.$parsers.unshift(f),
        ...
        function (a, c) {
          ...
          return {
            ...
            link: function (e, f, g) {
              ...
              (r(g, function (a, c) {
                s.test(c) &&
                  (l[x(c.replace("when", "").replace("Minus", "-"))] = f.attr(
                    g.$attr[c],
                  ));
              }),
                r(l, function (a, e) {
                ...
                e.$watch(
                  function () {
                    ...
                    return isNaN(c)
                      ? ""
                      : (c in l || (c = a.pluralCat(c - m)), n[c](e, f, !0));
                  },
                  function (a) {
                    f.text(a);
                  },
              ...
              function n(e, f, g) {
                function h() {
                  ...
                  for (C = 0; (G = F.length), G > C; C++) {
                    ...
                    ((Q[m] = u[k]),
                      ...
                      p
                        ? (d = D(v.remove(w ? w(e, Q) : x(e, Q))))
                        : (w
                            ? ((d = {}), (d[m] = s), (d = w(e, d) === w(e, Q)))
                            : (d = s === x(e, Q)),
                          (v = v || d)),
                      (E = l(e, Q)),
                      (E = D(E) ? E : ""),
                    ...
                    for (
                      ...
                      ((d = k[C]),
                        (v = u[C + 1])
                          ? ((E = v.element),
                            v.label !== d.label &&
                              (E.text((v.label = d.label)),
                              E.prop("label", v.label)),
                            v.id !== d.id && E.val((v.id = d.id)),
                            E[0].selected !== d.selected &&
                              (E.prop("selected", (v.selected = d.selected)),
                              R && E.prop("selected", v.selected)))
                          : ("" === d.id && z
                              ? (K = z)
                              : (K = t.clone())
                                  .val(d.id)
                            ...
                            q.addOption(d.label, K),
                            E ? E.after(K) : s.element.append(K),
                            (E = K)));
                    for (C++; u.length > C; )
                      ((d = u.pop()),
                ...
                (z && (a(z)(e), z.removeClass("ng-scope"), z.remove()),
                  ...
                  e.$watchCollection(function () {
                    ...
                    if (c) {
                      for (
                        var d = Array(c.length), f = 0, g = c.length;
                        g > f;
                        f++
                      )
                        ((a[m] = c[f]), (d[f] = l(e, a)));
  ...
  (function (G, d, P) {
    "use strict";
    d.module("ngAnimate", ["ng"])
      .directive("ngAnimateChildren", function () {
        return function (H, z, e) {
          ((e = e.ngAnimateChildren),
            d.isString(e) && 0 === e.length
              ? z.data("$$ngAnimateChildren", !0)
              : H.$watch(e, function (d) {
            ...
            function (y, G, aa, J, K, k) {
              ...
              function F(a, b, c, f, e, m, p) {
                ...
                if (n) {
                  ...
                  if (
                    (n.isClassBased &&
                      (D = u.running || u.disabled || (C && !C.isClassBased)),
                    D || N(c, f))
                  )
                    (t(), l(), A(), v());
                  else {
                    ...
                    if (
                      (!n.isClassBased ||
                        n.isSetClassOperation ||
                        f ||
                        (f = ("addClass" == a) == c.hasClass(b)),
                      f)
                    )
                      (t(), l(), A(), q());
                    else {
                      ...
                      (h++,
                        ...
                        n.before(function (e) {
                          ...
                          ((e =
                            ...
                            !d ||
                            !d.active[b] ||
                            (n.isClassBased && d.active[b].event != a)),
                            t(),
                            !0 === e ? v() : (A(), n.after(v)));
                        }));
                    }
              ...
              function V(a) {
                (a = e(a)) &&
                  ((a = d.isFunction(a.getElementsByClassName)
                    ? a.getElementsByClassName(I)
                    : a.querySelectorAll("." + I)),
                  w(a, function (a) {
                    ((a = d.element(a)),
                      (a = a.data(g)) &&
                        a.active &&
                        w(a.active, function (a) {
                          a.cancel();
                        }));
                  }));
              }
            ...
            z.register("", [
              ...
              function (g, h, z, J) {
                ...
                function W(a, b, c, d) {
                  ...
                  if (
                    ((a = b.data(u)),
                    -1 != k.getAttribute("class").indexOf(c) && a)
                  ) {
                    var n = "";
                    ...
                    if (0 < l.transitionDuration) {
                      ...
                      -1 == B.indexOf("all") &&
                        ((r += m + "transition-property: " + B + ";"),
                        (r +=
                          m +
                          "transition-duration: " +
                          l.transitionDurationStyle +
                          ";"),
                        s.push(m + "transition-property"),
                        s.push(m + "transition-duration"));
                    }
                    return (
                      q > 0 &&
                        (0 < p.transitionDelay &&
                          0 === p.transitionDuration &&
                          ((r +=
                            m +
                            "transition-delay: " +
                            U(l.transitionDelayStyle, p.transitionDelay, q) +
                            "; "),
                          s.push(m + "transition-delay")),
                        0 < p.animationDelay &&
                          0 === p.animationDuration &&
                          ((r +=
                            m +
                            "animation-delay: " +
                            U(l.animationDelayStyle, p.animationDelay, q) +
                            "; "),
                          s.push(m + "animation-delay"))),
                      0 < s.length &&
                        ((l = k.getAttribute("style") || ""),
                        k.setAttribute("style", l + "; " + r)),
                      b.on(z, h),
                      b.addClass(n),
                      ...
                      (k =
                        (q *
                          (Math.max(p.animationDelay, p.transitionDelay) || 0) +
                          (v + t) * D) *
                        ca),
                      a.running++,
                      E(b, k),
                ...
                function f(a, b) {
                  ...
                  c &&
                    (c.running && c.running--,
                    (c.running && 0 !== c.running) || a.removeData(u));
                }
                ...
                var p,
                  ...
                  A,
                  m = "";
                (G.ontransitionend === P && G.onwebkittransitionend !== P
                  ? ((m = "-webkit-"),
                    (p = "WebkitTransition"),
                    (H = "webkitTransitionEnd transitionend"))
                  : ((p = "transition"), (H = "transitionend")),
                  G.onanimationend === P && G.onwebkitanimationend !== P
                    ? ((m = "-webkit-"),
                      (l = "WebkitAnimation"),
                      (A = "webkitAnimationEnd animationend"))
                    : ((l = "animation"), (A = "animationend")));
                var L,
                  Q = "Duration",
                  t = "Property",
                  v = "Delay",
            ...
            : (0 === a.indexOf("<!--")
                ? ((b = a.indexOf("--", 4)),
                  b >= 0 &&
                    ...
                    (k = !1)))
                : z.test(a)
                  ? (b = a.match(z)) && ((a = a.replace(b[0], "")), (k = !1))
                  : K.test(a)
                    ? (b = a.match(A)) &&
      ...
      g.module("ngSanitize").filter("linky", [
        ...
        function (a) {
          ...
          return function (e, b) {
            ...
            if (!e) return e;
            for (var n, l, p, h = e, m = []; (n = h.match(d)); )
              ((l = n[0]),
                n[2] == n[3] && (l = "mailto:" + l),
                (p = n.index),
                k(h.substr(0, p)),
...
(!(function () {
  if (
      ...
      ((c.version = "0.9.16"),
        ...
        (c.connect = function (a, d) {
          ...
          (b &&
            ...
            (e.host =
              e.host || (b.document ? b.document.domain : b.location.hostname)),
          ...
          return (
            c.util.merge(h, d),
            (h["force new connection"] || !c.sockets[f]) &&
              (g = new c.Socket(h)),
            !h["force new connection"] && g && (c.sockets[f] = g),
            (g = g || c.sockets[f]),
    ...
    (function (a, b) {
      ...
      ((c.parseUri = function (a) {
          ...
          return (
            "document" in b
              ? ((d = d || document.domain),
                (e =
                  e ||
                  ("https" == c && "https:" !== document.location.protocol
                    ? 443
                    : document.location.port)))
              : ((d = d || "localhost"), !e && "https" == c && (e = 443)),
            (c || "http") + "://" + d + ":" + (e || 80)
          );
        }),
        ...
        (c.chunkQuery = function (a) {
          for (var f, b = {}, c = a.split("&"), d = 0, e = c.length; e > d; ++d)
            ((f = c[d].split("=")), f[0] && (b[f[0]] = f[1]));
          return b;
        }));
      var f = !1;
      ((c.load = function (a) {
        return ("document" in b && "complete" === document.readyState) || f
          ? a()
          : void c.on(b, "load", a, !1);
      }),
        ...
        (c.defer = function (a) {
          return c.ua.webkit && "undefined" == typeof importScripts
            ? void c.load(function () {
                setTimeout(a, 100);
              })
            : a();
        }),
        ...
        (c.indexOf = function (a, b, c) {
          for (
            var d = a.length, c = 0 > c ? (0 > c + d ? 0 : c + d) : c || 0;
            d > c && a[c] !== b;
            c++
          );
          return c >= d ? -1 : c;
      ...
      ((a.EventEmitter = c),
        ...
        (c.prototype.emit = function (a) {
          ...
          if ("function" == typeof c) c.apply(this, d);
            ...
            for (var e = c.slice(), f = 0, g = e.length; g > f; f++)
              e[f].apply(this, d);
          }
          return !0;
        }));
      ...
      ((c.encodePacket = function (a) {
        ...
        switch (a.type) {
          ...
          case "ack":
            k =
              a.ackId +
              (a.args && a.args.length ? "+" + g.stringify(a.args) : "");
        }
        var o = [b, c + ("data" == j ? "+" : ""), i];
      ...
      ((a.Transport = c),
        ...
        (c.prototype.onPacket = function (a) {
          return (
            ...
            "heartbeat" == a.type
              ? this.onHeartbeat()
              : ("connect" == a.type && "" == a.endpoint && this.onConnect(),
                "error" == a.type &&
                  "reconnect" == a.advice &&
                  (this.isOpen = !1),
      ...
      function d(a) {
        if (
          ...
          this.options["sync disconnect on unload"] &&
            (!this.isXDomain() || b.util.ua.hasCORS))
        ) {
          var d = this;
          b.util.on(
            c,
      ...
      ((a.Socket = d),
        ...
        (d.prototype.publish = function () {
          ...
          for (var b in this.namespaces)
            this.namespaces.hasOwnProperty(b) &&
              ((a = this.of(b)), a.$emit.apply(a, arguments));
        }),
        (d.prototype.handshake = function (a) {
          function f(b) {
            b instanceof Error
              ? ((c.connecting = !1), c.onError(b.message))
          ...
          if (this.isXDomain() && !b.util.ua.hasCORS) {
            ...
            (j.open("GET", g, !0),
              this.isXDomain() && (j.withCredentials = !0),
        ...
        (d.prototype.getTransport = function (a) {
          for (var f, c = a || this.transports, e = 0; (f = c[e]); e++)
            if (
              b.Transport[f] &&
              b.Transport[f].check(this) &&
              (!this.isXDomain() || b.Transport[f].xdomainCheck(this))
            )
            ...
            this.handshake(function (d, e, f, g) {
              function h(a) {
                return (
                  ...
                  c.transport
                    ? void c.transport.ready(c, function () {
                        ((c.connecting = !0),
                          ...
                          c.options["connect timeout"] &&
                            (c.connectTimeoutTimer = setTimeout(function () {
                              if (
                                !c.connected &&
                                ((c.connecting = !1),
                                c.options["try multiple transports"])
                              ) {
                                for (
                                  var a = c.transports;
                                  a.length > 0 &&
                                  a.splice(0, 1)[0] != c.transport.name;
                                );
              ...
              ((c.sessionid = d),
                ...
                c.transports ||
                  (c.transports = c.origTransports =
                    g
                      ? b.util.intersect(g.split(","), c.options.transports)
                      : c.options.transports),
        ...
        (d.prototype.isXDomain = function () {
          var a =
            c.location.port || ("https:" == c.location.protocol ? 443 : 80);
          return (
            this.options.host !== c.location.hostname || this.options.port != a
          );
        }),
        ...
        (d.prototype.reconnect = function () {
          ...
          function f() {
            return a.reconnecting
              ? a.connected
                ? e()
                : a.connecting && a.reconnecting
                  ? (a.reconnectionTimer = setTimeout(f, 1e3))
                  : void (a.reconnectionAttempts++ >= b
                      ? a.redoTransports
                        ? (a.publish("reconnect_failed"), e())
                        : (a.on("connect_failed", f),
                          (a.options["try multiple transports"] = !0),
                          (a.transports = a.origTransports),
                          (a.transport = a.getTransport()),
                          (a.redoTransports = !0),
                          a.connect())
                      : (a.reconnectionDelay < d && (a.reconnectionDelay *= 2),
                        a.connect(),
                        a.publish(
                          "reconnecting",
                          a.reconnectionDelay,
                        ...
                        (a.reconnectionTimer = setTimeout(
                          f,
                          a.reconnectionDelay,
                        ))))
              : void 0;
    ...
    (function (a, b) {
      ...
      ((a.SocketNamespace = c),
        ...
        (c.prototype.send = function (a, b) {
          ...
          return (
            "function" == typeof b &&
              ((c.id = ++this.ackPackets), (c.ack = !0), (this.acks[c.id] = b)),
            this.packet(c)
          );
        }),
        (c.prototype.emit = function (a) {
    ...
    (function (a, b, c) {
      ...
      ((a.websocket = d),
        ...
        (d.prototype.open = function () {
          var e,
            a = b.util.query(this.socket.options.query),
            d = this;
          return (
            e || (e = c.MozWebSocket || c.WebSocket),
        ...
        (d.prototype.send = b.util.ua.iDevice
          ? function (a) {
              var b = this;
              return (
                setTimeout(function () {
        ...
        (d.check = function () {
          return (
            ("WebSocket" in c && !("__addTask" in WebSocket)) ||
            "MozWebSocket" in c
          );
        }),
    ...
    (function (a, b) {
      ...
      ((a.flashsocket = c),
          ...
          function e() {
            ...
            (c.loaded ||
              ("undefined" == typeof WEB_SOCKET_SWF_LOCATION &&
                (WEB_SOCKET_SWF_LOCATION = g.join("/")),
              843 !== e &&
        ...
        "undefined" != typeof window &&
          (WEB_SOCKET_DISABLE_AUTO_INITIALIZATION = !0),
    ...
    var swfobject = (function () {
        ...
        if (f) {
          ...
          !(function () {
            if (typeof f.GetVariable != a) {
              ...
              return (g++, void setTimeout(arguments.callee, 10));
          ...
          if ((typeof c.id == a && (c.id = f), y.ie && y.win)) {
            ...
            for (var j in c)
              c[j] != Object.prototype[j] &&
                ("data" == j.toLowerCase()
                  ? (d.movie = c[j])
                  : "styleclass" == j.toLowerCase()
                    ? (i += ' class="' + c[j] + '"')
                    : "classid" != j.toLowerCase() &&
                      (i += " " + j + '="' + c[j] + '"'));
            var k = "";
            for (var l in d)
            ...
            for (var o in c)
              c[o] != Object.prototype[o] &&
                ("styleclass" == o.toLowerCase()
                  ...
                  : "classid" != o.toLowerCase() && m.setAttribute(o, c[o]));
            for (var p in d)
      ...
      }
      {
        ...
        (!(function () {
          y.w3 &&
            (((typeof i.readyState != a && "complete" == i.readyState) ||
  ...
  (!(function () {
        ...
        swfobject.hasFlashPlayerVersion("10.0.0")
          ? ("file:" == location.protocol &&
            ...
            (WebSocket.prototype.dispatchEvent = function (a) {
              for (
                var b = this.__events[a.type] || [], c = 0;
                c < b.length;
                ++c
              )
                b[c](a);
            ...
            (WebSocket.__onFlashEvent = function () {
              return (
                setTimeout(function () {
                  try {
                    for (
                      var b = WebSocket.__flash.receiveEvents(), c = 0;
                      c < b.length;
                      ++c
                    )
                      WebSocket.__instances[b[c].webSocketId].__handleEvent(
                        b[c],
                      );
                  } catch (d) {
                    a.error(d);
            ...
            (WebSocket.__isFlashLite = function () {
              ...
              return a &&
                a.enabledPlugin &&
                a.enabledPlugin.filename &&
                a.enabledPlugin.filename.match(/flashlite/i)
                ? !0
                : !1;
            }),
            ...
            void 0)
          : void a.error("Flash Player >= 10.0.0 is required.")
      );
    }
  })(),
    (function (a, b, c) {
      ...
      ((a.XHR = d),
        ...
        (d.prototype.post = function (a) {
          function d() {
            4 == this.readyState &&
              ...
              (b.posting = !1),
              200 == this.status ? b.socket.setBuffer(!1) : b.onClose());
          }
          ...
          (this.socket.setBuffer(!0),
            ...
            c.XDomainRequest && this.sendXHR instanceof XDomainRequest
        ...
        (d.prototype.request = function (a) {
          ...
          if ((c.open(a || "GET", this.prepareUrl() + d, !0), "POST" == a))
            try {
              c.setRequestHeader
      ...
      ((a.htmlfile = c),
        ...
        (c.check = function (a) {
          if (
            ...
            try {
              var c = new window[["Active"].concat("Object").join("X")](
                "htmlfile",
              );
    ...
    (function (a, b, c) {
      ...
      ((a["xhr-polling"] = d),
        ...
        (d.prototype.heartbeats = function () {
          return !1;
        }),
        (d.prototype.open = function () {
          var a = this;
        ...
        (d.prototype.get = function () {
          function b() {
            4 == this.readyState &&
              ((this.onreadystatechange = e),
              200 == this.status
                ? (a.onData(this.responseText), a.get())
                : a.onClose());
          }
          ...
          function f() {
            (a.retryCounter++,
              !a.retryCounter || a.retryCounter > 3 ? a.onClose() : a.get());
          }
          if (this.isOpen) {
            var a = this;
            ((this.xhr = this.request()),
              c.XDomainRequest && this.xhr instanceof XDomainRequest
                ? ((this.xhr.onload = d), (this.xhr.onerror = f))
        ...
        prototype: {
          ...
          check: function (element) {
            ...
            return dependencyMismatch
              ? void 0
              : (this.objectLength(rules) && this.successList.push(element),
                !0);
          },
          ...
          return (
            $.each(rules, function (prop, val) {
              ...
              if (val.param || val.depends) {
                ...
                keepRule
                  ? (rules[prop] = void 0 !== val.param ? val.param : !0)
                  : delete rules[prop];
              }
            }),
  ...
  jQuery.validator.addMethod(
    ...
    function (v) {
      ...
      for (i = 0; 17 > i; i++) {
        if (
          ((f = FL[i]), (d = v.slice(i, i + 1)), 8 === i && (cdv = d), isNaN(d))
        ) {
    ...
    function (phone_number, element) {
      return (
        ...
        this.optional(element) ||
          (phone_number.length > 9 &&
            phone_number.match(
              /^(?:(?:(?:00\s?|\+)44\s?)|(?:\(?0))(?:(?:\d{5}\)?\s?\d{4,5})|(?:\d{4}\)?\s?(?:\d{5}|\d{3}\s?\d{3}))|(?:\d{3}\)?\s?\d{3}\s?\d{3,4})|(?:\d{2}\)?\s?\d{4}\s?\d{4}))$/,
            ))
      );
    },
    "Please specify a valid phone number",
    ...
    function (postcode, element) {
      return (
        ...
        this.optional(element) ||
          ...
          postcode.match(/^([^QV][^IJZ]\d[ABEHMNPRVWXY])(\d[^CIKMOV]{2})$/) ||
  ...
  jQuery.validator.addMethod(
    ...
    function (value, element, param) {
      ...
      var validTypes = 0;
      return (
        param.mastercard && (validTypes |= 1),
        param.visa && (validTypes |= 2),
        param.amex && (validTypes |= 4),
        param.dinersclub && (validTypes |= 8),
        param.enroute && (validTypes |= 16),
        param.discover && (validTypes |= 32),
        param.jcb && (validTypes |= 64),
        param.unknown && (validTypes |= 128),
        param.all && (validTypes = 255),
        1 & validTypes && /^(5[12345])/.test(value)
          ? 16 === value.length
          : 2 & validTypes && /^(4)/.test(value)
            ? 16 === value.length
            : 4 & validTypes && /^(3[47])/.test(value)
              ? 15 === value.length
              : 8 & validTypes && /^(3(0[012345]|[68]))/.test(value)
                ? 14 === value.length
                : 16 & validTypes && /^(2(014|149))/.test(value)
                  ? 15 === value.length
                  : 32 & validTypes && /^(6011)/.test(value)
                    ? 16 === value.length
                    : 64 & validTypes && /^(3)/.test(value)
                      ? 16 === value.length
                      : 64 & validTypes && /^(2131|1800)/.test(value)
                        ? 15 === value.length
                        : 128 & validTypes
                          ? !0
                          : !1
      ...
      if (
        ...
        for (i = 0; i < element.files.length; i++)
          if (
            ...
            !file.type.match(new RegExp(".?(" + typeParam + ")$", "i")))
          )
            return !1;
      return !0;
    },
  ...
  jQuery.extend(jQuery.validator.messages, {
    ...
    maxlength: jQuery.validator.format(
      "Por favor, insira no máximo {0} caracteres.",
    ),
    ...
    postalcode_pt:
      "Por favor, insira o código postal no formato correto. Ex.: 1600-077",
  }),
  (FormBuilder.prototype.createValidation = function (validationParams) {
    var _this = this,
      rules = [];
    (isDefined(validationParams.messages) &&
      this.addValidationMessages(validationParams.messages),
      isDefined(validationParams.rules) && (rules = validationParams.rules),
  ...
  (FormBuilder.prototype.errorPlacement = function (error, ele) {
    var element = $(ele),
      ...
      err = null;
    ((err = isDefined(parentData, !1)
      ? $(parentData).find(isDefined(this.params.error_selector, ".frm-error"))
      : element
          .closest(isDefined(this.params.parent_line_selector, ".form-group"))
          .find(isDefined(this.params.error_selector, ".frm-error"))),
      err.html(error),
      err.show());
  }),
  ...
  (FormBuilder.prototype.bindConditionals = function (obj) {
    function eventHandler() {
      ...
      null != startCheck &&
        (startsWith =
          0 == cond.val().indexOf(startCheck.toLowerCase()) ||
          0 == cond.val().indexOf(startCheck));
      var rules = {
        required: !0,
      };
      ...
      if (
        cond.is(":checked") ||
        (cond.val() == val && null != val) ||
        startsWith
      )
        (req.rules("add", rules), blockToShow.length > 0 && blockToShow.show());
      else {
    ...
    var idVal = new Date().getTime(),
      ...
      blockToShow =
        "undefined" != typeof obj.parent_block
          ? req.parents(obj.parent_block)
          : [],
      val = isDefined(obj.value_to_check, null);
    (cond.bind(
      "change.FormBuilder" +
        idVal +
        " ifChanged.FormBuilder" +
        idVal +
        " keyup.FormBuilder" +
        idVal,
      eventHandler,
...
var harishPortfolioApp = angular.module(
  "harishPortfolioApp",
...
(harishPortfolioApp.config([
  "$controllerProvider",
  "$animateProvider",
  function ($controllerProvider, $animateProvider) {
  ...
  (Portfolio.prototype.scrollHandler = function () {
    ...
    if (
      vTop >= this.blockTop &&
      vTop <= this.blockTop + this.blockH - this.modalH - 120 - 60
    ) {
  ...
  (Portfolio.prototype.resizeHandler = function (isResize) {
    ...
    return this.winW == newW && isResize
      ? !1
      : ((this.winW = newW),
  ...
  (ScrollControler.prototype.scrollHandler = function () {
    ((this.scrollT = this.win.scrollTop()),
      this.scrollT + this.winH >= this.objCon.posTop + this.winH / 2 &&
        !this.objCon.hasAnimClass &&
        this.isAnim &&
        (this.objCon.addClass("anim"), (this.objCon.hasAnimClass = !0)));
  }),
  ...
  (ScrollControler.prototype.resizeHandler = function () {
    ...
    return this.winW == newW && this.winH == newH
      ? !1
      : ((this.winH = newH),
        (this.winW = newW),
  ...
  (Navigation.prototype.goToItem = function (obj) {
    ...
    var posGoTo,
      tar =
        ...
        obj.attr("data-" + this.targetAttr)),
      goTo = $("[data-" + this.contAttr + '="' + tar + '"]').eq(0);
    (ga("send", "pageview", "/" + obj.text().toLowerCase()),
      (posGoTo =
        "true" == goTo.attr("data-center")
          ? goTo.offset().top -
            (_scrollControl.winH / 2 - goTo.outerHeight() / 2)
          : goTo.offset().top),
  ...
  (TwitterWall.prototype.createTweet = function (data) {
    ...
    return {
      ...
      image: data.image,
      text: data.text
        .replace(hashRegex, "<em>#$1</em>")
        .replace(retweetRegex, "<strong>RT @$1: </strong>")
        .replace(linksRegex, '<a href="$1" target="_blank">$1</a>'),
      imageVisible: !0,
  ...
  (TwitterWall.prototype.tweetThis = function (e) {
    ...
    var width = 575,
      ...
      url =
        ...
        "?text=" +
        encodeURIComponent(
          "Check out the new @goncalocardo_o’s portfolio, developed using #mongoDB, #AngularJS and #nodejs. #harish",
        ),
      opts =
        "status=1,width=" +
        width +
...
/* Project slider moved from inline index.html */
(function () {
  var current = 0;
  var slides = [];
  var dots = [];
  ...
  window.projSlider = function (dir) {
    goTo(current + dir);
  };

  window.projGoTo = function (n) {
    goTo(n);
  };

  document.addEventListener("DOMContentLoaded", function () {
    slides = Array.prototype.slice.call(
      document.querySelectorAll(".proj-slide"),
    );
    dots = Array.prototype.slice.call(document.querySelectorAll(".proj-dot"));
